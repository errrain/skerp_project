...
class Submaterial(models.Model):
    ...
    customer = models.ForeignKey(Vendor,
    related_name="submaterial_set", on_delete=models.SET_NULL, blank=True, null=True, verbose_name="고객사")
...
class SubmaterialPrice(models.Model):
    submaterial = models.ForeignKey(Submaterial, on_delete=models.CASCADE, related_name='prices', verbose_name="부자재")
