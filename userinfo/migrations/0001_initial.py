    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.CharField(choices=[('admin', '관리자'), ('user', '사용자')], default='user', max_length=10, verbose_name='레벨')),
                ('status', models.CharField(choices=[('pending', '대기'), ('active', '승인')], default='pending', max_length=10, verbose_name='상태')),
